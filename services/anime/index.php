...
<body class="background bulat1 bulat2">
    ...
    <div class="content">
        <div class="service-container">
            ...
            <div class="form-dropdown" id="form1">
                <form method="get" action="search.php">
                    <div class="wrapper">
                        <input type="hidden" name="mode" value="search">
                        <input class="service-container-search" placeholder="Search Anime...." type="text" name="q"
                            minlength="3" required>
                        <button class="button">Search</button>
                    </div>
                </form>
            </div>
            <div class="form-dropdown" id="form2">
                <form method="get" action="search.php">
                    <div class="wrapper">
                        <input type="hidden" name="mode" value="recommend">
                        <input class="service-container-search" placeholder="Search for Anime similar To..." type="text"
                            name="q" minlength="3" required>
                        <button class="button">Search</button>
                    </div>
                </form>
            </div>
